...
export const metadata: Metadata = {
  title: 'Current Account | MNS Bank - Empower Your Business',
  description: 'MNS Bank Current Accounts are designed for businesses, professionals, and traders. Enjoy high transaction limits, overdraft facilities, and seamless digital banking.',
}
