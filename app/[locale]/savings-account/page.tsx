...
export const metadata: Metadata = {
  title: 'Savings Account | MNS Bank - Secure Your Future',
  description: 'Open a savings account with MNS Bank and enjoy competitive interest rates, mobile banking, and a host of other benefits. Secure your hard-earned money with us.',
}
