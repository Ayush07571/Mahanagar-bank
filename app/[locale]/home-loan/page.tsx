...
export const metadata: Metadata = {
  title: 'Home Loans | MNS Bank - Build Your Dream Home in Bhopal',
  description: 'Apply for home loans with MNS Bank at attractive interest rates starting from 8.35%. Flexible tenure up to 30 years and quick processing for home purchase and construction.',
}
